...
ALTER TABLE modifier_groups ADD COLUMN updated_at DATETIME DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE modifier_options ADD COLUMN updated_at DATETIME DEFAULT CURRENT_TIMESTAMP;
