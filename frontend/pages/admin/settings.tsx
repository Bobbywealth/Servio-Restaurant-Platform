          ...
          <div className="p-6 space-y-6">
            ...
            <label className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">Show the platform as in maintenance to admin operators.</p>
              </div>
              <input
                type="checkbox"
            ...
            <label className="flex items-start justify-between gap-4">
              ...
              <input
                type="checkbox"
                className="h-4 w-4 mt-1"
                checked={settings.allowNewDemoBookings}
                onChange={(e) => setSettings((prev) => ({ ...prev, allowNewDemoBookings: e.target.checked }))}
                disabled={isLoading || isSaving}
              />
            </label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  max={200}
                  className="w-full rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 px-3 py-2 text-sm"
                  value={settings.defaultOrderPageSize}
                  onChange={(e) => setSettings((prev) => ({ ...prev, defaultOrderPageSize: Number(e.target.value) || 50 }))}
                  disabled={isLoading || isSaving}
                />
              </div>
              <div>
