      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <section className="bg-white dark:bg-gray-800 shadow rounded-lg p-4 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
            <select value={filters.restaurantId} onChange={(e) => setFilters(prev => ({ ...prev, restaurantId: e.target.value }))} className="input-field">
              <option value="">All restaurants</option>
              {restaurants.map((restaurant) => <option key={restaurant.id} value={restaurant.id}>{restaurant.name}</option>)}
            </select>

            <select value={filters.channel} onChange={(e) => setFilters(prev => ({ ...prev, channel: e.target.value }))} className="input-field">
            ...
            <select value={filters.status} onChange={(e) => setFilters(prev => ({ ...prev, status: e.target.value }))} className="input-field">
            ...
            <select value={filters.timeWindowHours} onChange={(e) => setFilters(prev => ({ ...prev, timeWindowHours: e.target.value }))} className="input-field">
            ...
            <select value={filters.slaBreached} onChange={(e) => setFilters(prev => ({ ...prev, slaBreached: e.target.value }))} className="input-field">
