...
import { OFFICIAL_SERVIO_LOGO, SERVIO_DECORATIVE_ICON } from '../lib/branding'
        ...
        <div className="relative overflow-hidden pt-16">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
            ...
            >
              ...
              >
                <img src={SERVIO_DECORATIVE_ICON} alt="" aria-hidden="true" className="w-4 h-4 mr-2" />
        ...
        <footer className="bg-gray-900 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              <div>
                <div className="flex items-center mb-4">
                  <img src={OFFICIAL_SERVIO_LOGO} alt="Servio Logo" className="h-8 w-auto brightness-0 invert" />
