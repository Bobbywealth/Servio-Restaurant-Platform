        ...
        <main className="flex-1 px-8 py-8">
          <div className="max-w-3xl">
            ...
            <p className="text-[#6a6a6a] mt-2">
              Update item availability, pricing, and modifiers right from the tablet.
            </p>
            <div className="mt-6 bg-[#1c1c1c] border border-[#2a2a2a] rounded-2xl p-6 shadow-[0_2px_8px_rgba(0,0,0,0.3)]">
              ...
              <ul className="space-y-2 text-sm text-[#6a6a6a]">
                <li>• Toggle items available/unavailable with quick filters.</li>
                <li>• Edit price, prep time, or photo with staff permissions.</li>
                <li>• Manage modifiers (add-ons, sizes) and default selections.</li>
              </ul>
            </div>
          </div>
        </main>
